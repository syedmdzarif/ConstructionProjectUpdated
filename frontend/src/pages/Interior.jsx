  ...
  return (
    <div className="w-full h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-8 font-mono">
      <div className="max-w-xl text-center border border-white/10 p-12 bg-slate-900/50 backdrop-blur rounded-lg">
        <span className="text-xs text-amber-500 tracking-widest uppercase block mb-2">// Sector 02</span>
        <h1 className="text-3xl font-black tracking-wider uppercase mb-4">Interior Architecture</h1>
        <p className="text-slate-400 text-sm leading-relaxed mb-6">
          Premium spatial configuration, bespoke material profiling, and advanced acoustic/lighting design deployment.
        </p>
