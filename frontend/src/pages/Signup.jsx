    ...
    <div className="w-full h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-6 font-mono">
      <div className="w-full max-w-md border border-white/10 p-8 sm:p-10 bg-slate-900/40 backdrop-blur-md rounded-xl shadow-2xl">
        ...
        <div className="mb-8 text-center">
          <span className="text-[10px] text-amber-500 tracking-[0.3em] uppercase block mb-2">// SECURITY PROTOCOL</span>
          <h1 className="text-2xl font-black tracking-wider uppercase text-white">CREATE ACCOUNT</h1>
          <p className="text-slate-500 text-xs mt-1">Join the Nexus build network.</p>
        </div>

        {/* Form Structure */}
        <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
          <div>
            <label className="block text-[11px] tracking-widest text-slate-400 uppercase mb-2">Username</label>
            <input 
              type="text" 
              placeholder="nxs_operator"
        ...
        <div className="mt-6 text-center text-xs text-slate-400">
          Already registered?{' '}
          <a href="/signin" className="text-amber-500 font-bold hover:underline">
            Sign In
          </a>
        </div>
